        ...
        datasets: [
            {
                ...
                backgroundColor: [CommunicationsColors[0], 'transparent', 'transparent', 'transparent'],
                hoverBackgroundColor: [CommunicationsColors[0], 'transparent', 'transparent', 'transparent'],
            },
            {
                label: "Comunicaciones Externas",
                id: "Comunicaciones Externas",
                data: [0, externalCommunicationsTotal, 0, 0],
                backgroundColor: ['transparent', CommunicationsColors[1], 'transparent', 'transparent'],
                hoverBackgroundColor: ['transparent', CommunicationsColors[1], 'transparent', 'transparent'],
            },
            {
                label: "Asuntos Públicos",
                id: "Asuntos Públicos",
                data: [0, 0, publicAffairsTotal, 0],
                backgroundColor: ['transparent', 'transparent', CommunicationsColors[2], 'transparent'],
                hoverBackgroundColor: ['transparent', 'transparent', CommunicationsColors[2], 'transparent'],
            },
            {
                label: "Transversales",
                id: "Transversales",
                data: [0, 0, 0, transversalTotal],
                backgroundColor: ['transparent', 'transparent', 'transparent', CommunicationsColors[3]],
                hoverBackgroundColor: ['transparent', 'transparent', 'transparent', CommunicationsColors[3]],
            }
        ],
    };
